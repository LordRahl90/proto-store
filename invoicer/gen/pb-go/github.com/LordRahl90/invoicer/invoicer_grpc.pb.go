...
type InvoicerClient interface {
	Create(ctx context.Context, in *Invoice, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *invoicerClient) Create(ctx context.Context, in *Invoice, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
type InvoicerServer interface {
	Create(context.Context, *Invoice) (*Response, error)
}
...
func (UnimplementedInvoicerServer) Create(context.Context, *Invoice) (*Response, error) {
...
func _Invoicer_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InvoicerServer).Create(ctx, req.(*Invoice))
	}
